...
namespace payload_planner
{
  PlanningVisualization::PlanningVisualization(ros::NodeHandle &nh)
  {
    ...
    ellipsoidPub = nh.advertise<visualization_msgs::MarkerArray>("drone_status", 10);
  }
  ...
  void PlanningVisualization::visualizeDoubleball(const poly_traj::Trajectory<7> &traj, int samples, double L, double gAcc, double PayloadSize, double QuadrotorSize)
  {
