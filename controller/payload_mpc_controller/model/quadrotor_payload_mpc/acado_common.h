 ...
 * 
 *  Matrix containing 20 reference/measurement vectors of size 26 for first 20 nodes.
 */
real_t y[ 520 ];
...
/** Matrix of size: 520 x 26 (row major format) */
real_t W[ 13520 ];
...
real_t objValueOut[ 26 ];

/** Matrix of size: 440 x 22 (row major format) */
real_t Q1[ 9680 ];

/** Matrix of size: 440 x 26 (row major format) */
real_t Q2[ 11440 ];

/** Matrix of size: 80 x 4 (row major format) */
real_t R1[ 320 ];

/** Matrix of size: 80 x 26 (row major format) */
real_t R2[ 2080 ];
...
/** Matrix of size: 4620 x 4 (row major format) */
real_t E[ 18480 ];
